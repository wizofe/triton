...
class MsCSD():
    ...
    def __init__(self):
        ...
        self.mass = 0
        self.massStd = 0
        self.gaussianParams = [] #not sure whether I should delete this and go with individual values as below
        self.amp = 0
        self.mu = 0
        self.fwhh = 0
    ...
    def plot_simulated_csd(self, ax, xaxis, fwhm=10, peakShape='gaussian', **kwargs):
