...
class Matcher(object):
    ...
    def __init__(self):
        ...
        self.column_headers_search_space = [
            'Sequence', 'Ion', 'Charge', 'Mass_Theor', 'Modifications',
            'Oligo_base', 'Mass_Obs', 'Intensity'
        ]
    ...
    def modify_oligo_fragments(self, fragment, modifications):
        ...
        return {
            ...
            'modification_mass': total_modification_mass
        }
                ...
                for z in charges:
                    ...
                    if abs(ppm_calculated) < ppm_error:
                        ...
                        data_to_save.append([
                            ...
                            experimental_mass, experimental_intensity, fragm_mz,
                            ppm_calculated, frag_string_modified, oligo_position
                        ])
    ...
    def match_oligo_fragments_pandas(self, df_search_space, mass_specrtum,
                                     ppm_error):
        """
        ...
        df_search_results = pd.DataFrame(
            search_results_array, columns=self.column_headers_search_space)
        df_search_results['ppm'] = (df_search_results['Mass_Theor'] -
                                    df_search_results['Mass_Obs']
